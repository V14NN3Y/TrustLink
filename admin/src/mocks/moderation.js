export const PRODUCTS = [
  ...
  { id: 'prod-004', name: 'Climatiseur Samsung WindFree 18000 BTU', category: 'Électroménager', seller_name: 'Cool Tech Lagos', seller_id: 'SLR-0037', price_ngn: 195000, price_xof: 357240, images: ['https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400'], description: 'Climatiseur Inverter classe A++.', status: 'PENDING_REVIEW', submitted_at: '2024-12-15T11:00:00Z' },
...
export const DISPUTES = [
  {
    ...
    messages: [
      { id: 1, role: 'BUYER', author: 'Rodrigue Akplogan', content: "J'ai reçu mon MacBook Pro avec l'écran complètement fissuré. Je veux un remboursement.", timestamp: '2024-12-13T16:05:00Z' },
      { id: 2, role: 'SELLER', author: 'Emeka Eze', content: 'Le produit était en parfait état à expédition. La dégradation vient du transport.', timestamp: '2024-12-13T16:45:00Z' },
      { id: 3, role: 'ADMIN', author: 'Admin TrustLink', content: 'Investigation ouverte. Les fonds restent bloqués en escrow.', timestamp: '2024-12-13T17:00:00Z' },
      ...
      { id: 5, role: 'SELLER', author: 'Emeka Eze', content: "Je suis prêt à rembourser 50% si l'admin confirme que le dommage n'est pas lié à mon packaging.", timestamp: '2024-12-14T10:30:00Z' },
    ]
  },
  {
    ...
    messages: [
      { id: 1, role: 'BUYER', author: 'Aurélien Kpossa', content: 'Les tissus reçus ne correspondent pas aux photos !', timestamp: '2024-12-15T09:05:00Z' },
      { id: 2, role: 'SELLER', author: 'Ngozi Fashion', content: 'Les couleurs peuvent varier selon les écrans. Produit conforme au stock.', timestamp: '2024-12-15T10:00:00Z' },
    ]
  },
  {
    ...
    messages: [
      { id: 1, role: 'BUYER', author: 'Félix Adandé', content: "Le générateur ne démarre pas. Défaut d'usine confirmé.", timestamp: '2024-12-10T14:05:00Z' },
      { id: 2, role: 'ADMIN', author: 'Admin TrustLink', content: 'Défaut confirmé. Remboursement total initié.', timestamp: '2024-12-12T11:00:00Z' },
    ]
  },
];
